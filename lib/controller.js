...
var _ = require('lodash'), parseSearch, isUniqueIssue, isSendObject, matchEmbed, CSVIEW = '$b.csview', bodyParser = require('body-parser');
	...
	generate : function (name,pathName,ext,opts,sendObjectInit) {
		...
		baseCtrlr = {
			...
			index: function(req,res,next) {
				var m = req.booster.models[name], filter = req.query[CSVIEW] || "public", search = _.omit(req.query,function (val,key) {
